...
LOAD_PATH=train_output/filtered_DECIMER_Randepict_first/checkpoint_epoch_30.pth
SAVE_PATH=test_output/test_filtered_DECIMER_Randepict_first/test_filtered_DECIMER_Randepict_epoch_30/
mkdir -p ${SAVE_PATH}
